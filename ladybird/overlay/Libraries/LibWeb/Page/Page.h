...
public:
    ...
    // Mersey interactive debugger: the engine paused at a breakpoint. Block until
    // DevTools resumes/steps and return the action (0=resume, 1=over, 2=in, 3=out).
    // Default (no DevTools attached) resumes immediately.
    virtual u8 mersey_debug_pause(String const&) { return 0; }
