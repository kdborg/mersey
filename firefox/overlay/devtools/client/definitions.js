...
loader.lazyGetter(
  ...
  "MerseyDebuggerPanel",
  () =>
    require("resource://devtools/client/mersey/panel.js").MerseyDebuggerPanel
);
loader.lazyGetter(
  this,
  "AccessibilityPanel",
...
// Mersey fork: the Mersey engine debugger — gutter breakpoints on the
// page's Mersey sources, pause/step, stack and scopes. Its own panel
// because the JS Debugger is built on SpiderMonkey's Debugger API, which
// never sees Mersey code.
Tools.merseydebugger = {
  id: "merseydebugger",
  ordinal: 12,
  icon: "chrome://devtools/skin/images/tool-debugger.svg",
  url: "chrome://devtools/content/mersey/index.html",
  label: "Mersey",
  panelLabel: "Mersey Debugger",
  tooltip: "Debug the page's Mersey code",
  inMenu: false,
  ...
  build(iframeWindow, toolbox, commands) {
    return new MerseyDebuggerPanel(iframeWindow, toolbox, commands).open();
  },
};
