...
// Mersey fork: choose the console input's language. The two languages share
// no bindings — see mersey/docs/architecture/devtools.md.
function setEvalLanguage(language) {
  return {
    type: EVAL_LANGUAGE_SET,
    language,
  };
}
