  ...
  methods: {
    ...
    evaluateJSAsync: {
      request: {
        ...
        // Mersey fork: which language this turn is written in
        // ("javascript" — the default — or "mersey").
        language: Option(0, "nullable:string"),
      },
    ...
    autocomplete: {
      request: {
        ...
        // Mersey fork: which language the console input is in. In Mersey mode
        // the completion surface is the Mersey session's, not the JS realm's.
        language: Arg(6, "nullable:string"),
      },
