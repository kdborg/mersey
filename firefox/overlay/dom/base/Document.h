...
#undef DOCUMENT_WARNING
 ...
 public:
  ...
  // The Mersey engine context for this document, if any Mersey script has run
  // in it. One context per document: a page's scripts share globals, as they
  // must. Created lazily by MerseyScriptRunner::For.
  MerseyScriptRunner* GetMerseyScriptRunner() const {
    return mMerseyScriptRunner;
  }
  void SetMerseyScriptRunner(MerseyScriptRunner* aRunner) {
    mMerseyScriptRunner = aRunner;
  }

 protected:
  RefPtr<MerseyScriptRunner> mMerseyScriptRunner;
