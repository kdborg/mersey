...
enum class ScriptKind : uint8_t {
  ...
  // Mersey fork: <script type="text/mersey">. Not JavaScript at all — the
  // source goes to the Mersey engine (dom/mersey), which type-checks it,
  // lowers it to bytecode and runs it. SpiderMonkey never sees it.
  eMersey,
