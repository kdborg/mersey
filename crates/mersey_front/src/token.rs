...
pub enum Punct {
    ...
    Semi, Comma, Dot, DotDotDot, QuestionDot, Colon, Question, Arrow,
    Plus, Minus, Star, Slash, Percent, StarStar,
    Eq, PlusEq, MinusEq, StarEq, SlashEq, PercentEq, StarStarEq,
    ShlEq, ShrEq, AmpEq, PipeEq, CaretEq, AmpAmpEq, PipePipeEq, QuestionQuestionEq,
    EqEq, NotEq, Lt, Gt, LtEq, GtEq, Shl, Shr,
    Amp, Pipe, Caret, Tilde, Bang, AmpAmp, PipePipe, QuestionQuestion,
    PlusPlus, MinusMinus,
}
...
impl Punct {
    pub fn as_str(self) -> &'static str {
        ...
        match self {
            ...
            LBrace => "{", RBrace => "}",
            Semi => ";", Comma => ",", Dot => ".", DotDotDot => "...",
            QuestionDot => "?.", Colon => ":", Question => "?", Arrow => "=>",
            Plus => "+", Minus => "-", Star => "*", Slash => "/",
            Percent => "%", StarStar => "**",
            Eq => "=", PlusEq => "+=", MinusEq => "-=", StarEq => "*=",
            SlashEq => "/=", PercentEq => "%=", StarStarEq => "**=",
            ShlEq => "<<=", ShrEq => ">>=", AmpEq => "&=", PipeEq => "|=",
