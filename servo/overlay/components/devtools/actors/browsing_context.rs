...
pub(crate) struct BrowsingContextActor {
    ...
    pub mersey_debugger_name: String,
...
impl BrowsingContextActor {
    ...
    pub(crate) fn register(
        ...
        let mersey_debugger_actor = crate::actors::mersey_debugger::MerseyDebuggerActor::register(
            registry,
            script_sender.clone(),
            pipeline_id,
        );
        ...
        let actor = BrowsingContextActor {
            ...
            mersey_debugger_name: mersey_debugger_actor.name().into(),
...
impl ActorEncode<BrowsingContextActorMsg> for BrowsingContextActor {
    fn encode(&self, _: &ActorRegistry) -> BrowsingContextActorMsg {
        BrowsingContextActorMsg {
            ...
            mersey_debugger_actor: self.mersey_debugger_name.clone(),
